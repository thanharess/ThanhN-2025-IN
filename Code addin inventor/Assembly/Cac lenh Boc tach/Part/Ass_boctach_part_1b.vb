    ...
    Public Module Ass_boctach_part_1b
        ...
        Public Sub OnExecute(ByVal Context As NameValueMap)
            ...
            Try
                ...
                ' For 1f we operate on top-level only and list unique purchased/library parts (no quantity sum)
                ...
                targetDoc.DisplayName = baseName & "_TopLevel_Unique"
        ...
        IsLibraryPart(pn)
                        ...
                        Try
                            Dim occ As ComponentOccurrence = targetDoc.ComponentDefinition.Occurrences.Add(doc.FullFileName, oMatrix)
                            added += 1
                        Catch
                        End Try
        ...
        End Function
        '==========================================================
        ' KIỂM TRA STANDARD / BEARING / FASTENER
        ' GIỐNG LOGIC BẢN 1E
        '==========================================================
        '==========================================================
        ...
        Private Function IsLibraryPart(ByVal pn As String) As Boolean
            ...
            Try
                If ToolInventor2025.Assembly.CommonKeywords.IsBearing(pn) Then
                    Return True
                End If
            Catch
            End Try
            ...
            Try
                If ToolInventor2025.Assembly.CommonKeywords.IsFastener(pn) Then
                    Return True
                End If
            Catch
            End Try
            ...
            Try
                If ToolInventor2025.Assembly.CommonKeywords.IsStandardKeyword(pn) Then
                    Return True
                End If
            Catch
            End Try
