...
Namespace ToolInventor2025.Drawing.Buttons.DrawPartList
    ...
    Public Module Draw_Partlist_1a

        '=========================================================
        ' OPTIONS CLASS
        '=========================================================
        Private Class PartlistOptions
        ...
        Public Sub OnExecute(ByVal Context As NameValueMap)
            ...
            Try
                ...
                ' FORM TÙY CHỌN
                '=================================================
                Dim opt As PartlistOptions = ShowOptionsForm()
        ...
        '=========================================================
        Private Function ShowOptionsForm() As PartlistOptions
            Dim opt As New PartlistOptions()
            Dim _okConfirmed As Boolean = False

            Using frm As New Form()
                frm.Text = "Ghi Partlist VIE — Tùy chọn"
                ...
                lblTitle.Text = "GHI PARTLIST VIE"
                ...
                lblSub.Text = "Ghi vật liệu / đơn vị / tên cho Parts List trong Drawing"
                ...
                Dim modeTexts As String() = {
                    "Part Number — không ghi đè nếu Tên đã là PN/SN",
                    "Part Number — chỉ ghi khi ô Tên đang trống",
                    "Stock Number — đồng bộ trực tiếp vào BOM",
                    "Không sửa tên (dùng Part Number để đoán đơn vị)",
                    "Stock Number — không ghi đè nếu Tên đã là PN/SN",
                    "Stock Number — chỉ ghi khi ô Tên đang trống",
   ...
   nameMode = 5 OrElse nameMode = 6 Then
        ...
        Private Function GetNameColumn(row As Inventor.PartsListRow) As String
            ...
            Try
                ...
                Dim value As String = CStr(row.Item("Tên chi tiết").Value)
            ...
            Try
                Dim value As String = CStr(row.Item("Tên gọi").Value)
                Return "Tên gọi"
